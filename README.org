...
For simple configurations, you can also use individual properties:
...
Some habits only make sense on specific days of the week. For example, you might go to the gym on Monday, Wednesday, and Friday, or do meal prep only on weekends. The =OWH_ONLY_DAYS= property lets you restrict which days count toward your habit.

When =OWH_ONLY_DAYS= is set:
